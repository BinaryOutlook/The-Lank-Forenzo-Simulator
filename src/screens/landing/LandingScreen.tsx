...
import {
  LANDING_POSTER_HIGHLIGHT_DOTS,
  LANDING_POSTER_SHADOW_DOTS,
  LANDING_POSTER_VIEW_BOX,
} from "./landingPosterDotPaths.js";
...
function LandingPosterArt() {
  return (
    <svg
      ...
      viewBox={LANDING_POSTER_VIEW_BOX}
      role="presentation"
      focusable="false"
    >
      <path
        className={styles.posterHighlightDots}
        d={LANDING_POSTER_HIGHLIGHT_DOTS}
      />
      <path
        className={styles.posterShadowDots}
        d={LANDING_POSTER_SHADOW_DOTS}
      />
    </svg>
  );
}
