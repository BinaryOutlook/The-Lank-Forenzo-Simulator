...
| FR-0021 | Local save options exploration | [Brief](issue-briefs/0021-local-save-options-exploration.md) | Persistence / player experience | Lets players resume sessions while creating a path toward future save integrity protections. | L | High | Medium | High | State serialization inventory, save versioning decision, storage target decision, tamper policy | Orange | P1 | In Progress | [Link](https://github.com/BinaryOutlook/The-Lank-Forenzo-Simulator/issues/106) | tlfs-orchestrator | Promoted to GitHub issue #106 and implemented as a non-encrypted Load Manager. Encrypted or tamper-resistant saves are tracked separately in FR-0024. |
