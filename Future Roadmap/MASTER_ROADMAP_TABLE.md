...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| FR-0017 | Unionization mechanics exploration | [Brief](issue-briefs/0017-unionization-mechanics-exploration.md) | Gameplay systems / historical texture | Adds historically grounded labor pressure that can represent worker protection, strike leverage, and union leadership self-dealing without turning labor into a one-note moral faction. | L | High | High | High | Product scope decision, faction/global-state design, event authoring model, balance review | Orange | P2 | Needs Architecture Review | None | Unassigned | Clarify design first. Unionization should be modeled clinically as a power system with legitimate worker protection, member trust, strike leverage, public sympathy, and possible leadership extraction before any implementation issue is opened. |
| FR-0018 | New game modes: union and regulators | [Brief](issue-briefs/0018-new-game-modes-union-regulators.md) | Gameplay modes / expansion | Expands replayability with reverse-play perspectives where players use labor or regulatory power while facing the same institutional temptations, legitimacy problems, and extraction risks as Executive mode. | L | High | High | High | Upstreaming mode completion, FR-0017 unionization mechanics direction, role-specific victory conditions, event and ending model | Orange | P2 | Needs Architecture Review | None | Unassigned | Preserve the familiar Read / Choose / Resolve quarter loop. Union and Regulators modes should model power clinically: unions can protect or exploit members, while regulators can protect public order or perform oversight under political, legal, and capture pressure. |
| FR-0024 | Encrypted local save integrity follow-up | [Brief](issue-briefs/0024-encrypted-local-save-integrity.md) | Persistence / save integrity | Adds a reviewed path toward private or tamper-resistant local saves after the non-encrypted Load Manager boundary stabilizes. | L | High | Medium | High | FR-0021 local save manager, save threat model, key-management decision, browser crypto compatibility review | Orange | P2 | Needs Architecture Review | None | Unassigned | Created as a follow-up to the non-encrypted Load Manager pass. Do not implement until the save-integrity goal is clarified. |
| FR-0026 | Two-tone dotted landing poster | [Brief](issue-briefs/0026-two-tone-dotted-landing-poster.md) | UI / visual theming | Replaces the heavy photo-style poster with a lightweight two-color dotted composition that adapts cleanly to every theme. | Medium | Medium | Medium | Low | FR-0025 | Yellow | P1 | In Progress | [Link](https://github.com/BinaryOutlook/The-Lank-Forenzo-Simulator/issues/113) | BinaryOutlook / sub-agents | Promoted to GitHub issue #113 and started immediately per user request. |
