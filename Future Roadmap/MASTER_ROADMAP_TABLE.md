...
| FR-0022 | Overhauled sub-tab UI experience | [Brief](issue-briefs/0022-overhauled-sub-tab-ui-experience.md) | UI architecture / responsive UX | Lets each gameplay panel focus on its core job instead of forcing dense text and state into one cluttered adaptive surface. | L | High | High | Medium | Current run-screen panel inventory, mobile and desktop navigation model, route and tab ownership decision, text-density direction | Orange | P1 | In Progress | [Link](https://github.com/BinaryOutlook/The-Lank-Forenzo-Simulator/issues/98) | Unassigned | Promoted to GitHub issue #98 for an architecture/design PR that defines the sub-tab model before implementation. |
| FR-0023 | Full and minimal text display modes | [Brief](issue-briefs/0023-text-display-density-modes.md) | Settings / accessibility / responsive UX | Gives players a full explanatory mode and a minimal phone-friendly mode so the game remains usable across aspect ratios and device sizes. | L | High | High | Medium | Settings model, UI copy inventory, mobile rendering audit, content summarization strategy, FR-0022 panel model decision | Orange | P1 | In Progress | [Link](https://github.com/BinaryOutlook/The-Lank-Forenzo-Simulator/issues/99) | Unassigned | Promoted to GitHub issue #99 for a text-density design contract before broad UI copy changes. |
