...
| FR-0025 | Theme-adaptive landing poster filter | [Brief](issue-briefs/0025-theme-adaptive-landing-poster-filter.md) | UI / visual theming | Lets the LFS halftone aircraft poster feel native in every current theme without duplicating artwork per theme. | Medium | Medium | Medium | Low | None | Yellow | P1 | In Progress | [Link](https://github.com/BinaryOutlook/The-Lank-Forenzo-Simulator/issues/109) | BinaryOutlook / AO agents | Promoted to GitHub issue #109 and started immediately per user request. |
